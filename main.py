...
SUBJECT_LIST = [
    ...
    'GENERAL MATHEMATICS', 'FURTHER MATHEMATICS', 'ENGLISH LANGUAGE', 'LITERATURE IN ENGLISH',
    ...
    'MARKETING', 'FOODS & NUTRITION', 'AGRICULTURAL SCIENCE', 'HOME MANAGEMENT', 'CATERING CRAFT PRACTICE'
]  # for reference
...
# I ADDED AGRICULTURAL_SCIENCE, HOME_MANAGEMENT, CATERING_CRAFT_PRACTICE TO THE LIST
...
FOOD_NUT_LIST, AGRICULTURAL_SCIENCE_LIST, HOME_MANAGEMENT_LIST, CATERING_CRAFT_PRACTICE_LIST = [], [], [], []
...
MARKETING_CHECK, FOOD_NUT_CHECK, AGRICULTURAL_SCIENCE_CHECK = 0, 0, 0
HOME_MANAGEMENT_CHECK, CATERING_CRAFT_PRACTICE_CHECK = 0, 0

for score in SCORE_LIST:
    # Check if a student has a subject in the result then add it to the required list, then count.
    if score.get('GENERAL MATHEMATICS'):
        MATHEMATICS_CHECK += 1
        MATHEMATICS_LIST.append(score.get('GENERAL MATHEMATICS'))
    ...
    if score.get('AGRICULTURAL SCIENCE'):
        AGRICULTURAL_SCIENCE_CHECK += 1
        AGRICULTURAL_SCIENCE_LIST.append(score.get('AGRICULTURAL SCIENCE'))

    if score.get('HOME MANAGEMENT'):
        HOME_MANAGEMENT_CHECK += 1
        HOME_MANAGEMENT_LIST.append(score.get('HOME MANAGEMENT'))

    if score.get('CATERING CRAFT PRACTICE'):
        CATERING_CRAFT_PRACTICE_CHECK += 1
        CATERING_CRAFT_PRACTICE_LIST.append(score.get('CATERING CRAFT PRACTICE'))
...
AGRICULTURAL_SCIENCE_SCORES = dict([[x, AGRICULTURAL_SCIENCE_LIST.count(x)] for x in set(AGRICULTURAL_SCIENCE_LIST)])
HOME_MANAGEMENT_SCORES = dict([[x, HOME_MANAGEMENT_LIST.count(x)] for x in set(HOME_MANAGEMENT_LIST)])
CATERING_CRAFT_PRACTICE_SCORES = dict([[x, CATERING_CRAFT_PRACTICE_LIST.count(x)]
                                       for x in set(CATERING_CRAFT_PRACTICE_LIST)])
...
print("AGRICULTURAL_SCIENCE: ", AGRICULTURAL_SCIENCE_SCORES, " ~ TOTAL: ", AGRICULTURAL_SCIENCE_CHECK)
print("HOME_MANAGEMENT_SCORES: ", HOME_MANAGEMENT_SCORES, " ~ TOTAL: ", HOME_MANAGEMENT_CHECK)
print("CATERING_CRAFT_PRACTICE_SCORES: ", CATERING_CRAFT_PRACTICE_SCORES, " ~ TOTAL: ", CATERING_CRAFT_PRACTICE_CHECK)
